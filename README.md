...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/lucky-silence-7049)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/lucky-silence-7049
```

A live public deployment of this template is available at [https://lucky-silence-7049.templates.workers.dev](https://lucky-silence-7049.templates.workers.dev)
